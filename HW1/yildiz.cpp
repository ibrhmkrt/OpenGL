...
void lineSegment(void)
{
	...
	glColor3f(0.0, 0.0, 0.0);//Çizginin rengini MAVÝ yapar
	glLineWidth(2.0);//Çizgi kalýnlýðýný 3 yaptýk               
	glBegin(GL_LINES);//Çizeceðimiz þekili Çizgi olarak belirttik
	glVertex2f(0.0, 0.9);//1.Nokta
	glVertex2f(0.7, -0.4);//2. Nokta 1-2 noktalarý çizgi oluþturur
	glVertex2f(0.7, -0.4);//3.Nokta
	glVertex2f(-0.7, 0.5);//4. Nokta 3-4 noktalarý çizgi oluþturur
	glVertex2f(-0.7, 0.5);//5.Nokta
	glVertex2f(0.7, 0.5);//6. Nokta 5-6 noktalarý çizgi oluþturur
	glVertex2f(0.7, 0.5);//7.Nokta
	glVertex2f(-0.7, -0.4);//8. Nokta 7-8 noktalarý çizgi oluþturur
	glVertex2f(-0.7, -0.4);//9.Nokta
	glVertex2f(0.0, 0.9);//10. Nokta 9-10 noktalarý çizgi oluþturur
...
int main(int argc, char* argv[])
{
	...
	glutCreateWindow("soru4");	// Pencerenin ismini yazdýk ve pencere oluþturduk
